      ...
      <div className="flex flex-col h-screen p-4 bg-[#1E1E1E] text-white justify-center items-center">
        ...
        <form className="bg-white p-6 rounded shadow-md w-full max-w-sm">
          <div className="mb-4">
            ...
            <input
              type="email"
              className="border border-gray-300 rounded p-2 w-full email"
            />
          </div>
          <div className="mb-4">
            ...
            <input
              type="password"
              className="border border-gray-300 rounded p-2 w-full password"
            />
          </div>
          <div className="mb-4">
            ...
            <input
              type="text"
              className="border border-gray-300 rounded p-2 w-full zip_code"
            />
          </div>
          <div className="mb-4">
            ...
            <input
              type="text"
              className="border border-gray-300 rounded p-2 w-full stay_length"
            />
          </div>
          <div className="mb-4">
            ...
            <input
              type="text"
              className="border border-gray-300 rounded p-2 w-full allergies"
            />
          </div>
          <div className="mb-4">
